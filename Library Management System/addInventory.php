	...
	<body>
		<div>
			<form action="addItem.php" method="GET">
			   <font size="4" color="#ffffff">Item ID</font><input type="text" name="Item_ID"><br>
			   <font size="4" color="#ffffff">Item Type</font><input type="text" name="Item_Type"><br>
			   <font size="4" color="#ffffff">Item Location</font><input type="text" name="Item_Location"><br>
