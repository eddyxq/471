<html>
	...
	<div>
		<form action="addItem.php" method="post">
		   <font size="4" color="#ffffff"><font size="4" color="#ffffff">Item ID</font><input type="text" name="Item_ID"><br>
		   <font size="4" color="#ffffff"><font size="4" color="#ffffff">Item_Type</font><input type="text" name="Item_Type"><br>
		   <font size="4" color="#ffffff"><font size="4" color="#ffffff">Item_Location</font><input type="text" name="Item_Location"><br>
