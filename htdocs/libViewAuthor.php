<html>
	...
	<body>
		...
		if(isset($_GET['job'])){
			...
			$result = mysqli_query($con,"Delete from authors where First_Name=". $First_Name. " AND Last_Name = ". $Last_Name);
			}	
		}
		...
		while($row = mysqli_fetch_array($result)){
			...
			echo "<td><a href='libUpdateAuthor.php?&amp;First_Name= " . $row['First_Name'] . "'>Update</a></td>";
			echo "<td><a onClick= \"return confirm('Do you want to delete this user?')\" href='libViewAuthor.php?job=delete&amp;First_Name=".$row['First_Name']."'>Delete</a></td>";
			echo "</tr>";
		}
