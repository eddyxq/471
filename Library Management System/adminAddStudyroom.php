<html>
	...
	<body>
		<div>
			<form action="addingStudyroom.php" method="GET">
				<font size="4" color="#ffffff">Room Number</font><input type="number" name="Room_Number"><br>
				<font size="4" color="#ffffff">Capacity</font><input type="number" name="Capacity"><br>
